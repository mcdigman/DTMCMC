...
class ProposalStrategyParameters():
    ...
    def __init__(self,config):
        ...
        #         cold_prior_weight=0.333,           # how often to do prior draws in the cold chains
        #         cold_de_weight=0.333,              # how often to do de draws in the cold chains
        #         hot_de_weight=0.333,               # how often to do de draws in the hottest finite temperature chain
        ...
        #         hot_prior_target_weight=0.333,     # how often to do prior draws in the hottest finite temperature chain
        ...
        self.config = config
        #self.fisher_strategy = fm.FisherStrategyParameters(self.config)
        #self.fisher_strategy = fm.FisherStrategyParameters(use_chol_fishers, cold_fisher_weight, hot_fisher_weight, fisher_subspace_frac, fisher_subspace_override_frac, fisher_downsample, sigma_default, max_fisher_el)
        #self.de_strategy = dm.DEStrategyParameters(self.config)
        ...
        #self.prior_strategy = pm.PriorStrategyParameters(self.config)
