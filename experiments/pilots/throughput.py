...
THROUGHPUT_CONFIGS: list[tuple[str, dict[str, Any]]] = [
    *[(f'gaussian{n_par}d_nc{n_chain}', {'name': 'gaussian', 'n_par': n_par, 'cutoff': 8}) for n_par in (5, 20) for n_chain in (8, 16, 48)],
    *[(f'cake{n_par}d_nc{n_chain}', {'name': 'cake', 'n_par': n_par, 'cutoff': 10}) for n_par in (5, 8) for n_chain in (8, 16, 48)],
