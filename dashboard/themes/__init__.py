...
LIGHT = Theme(
    ...
    sequential_ramp=('#cde2fb', '#b7d3f6', '#9ec5f4', '#86b6ef', '#6da7ec', '#5598e7', '#3987e5', '#2a78d6', '#256abf', '#1c5cab', '#184f95', '#104281', '#0d366b'),
...
DARK = Theme(
    ...
    sequential_ramp=('#0d366b', '#104281', '#184f95', '#1c5cab', '#256abf', '#2a78d6', '#3987e5', '#5598e7', '#6da7ec', '#86b6ef', '#9ec5f4', '#b7d3f6', '#cde2fb'),
    ordinal_ramp=('#184f95', '#1c5cab', '#256abf', '#2a78d6', '#3987e5', '#5598e7', '#6da7ec', '#86b6ef', '#9ec5f4', '#b7d3f6', '#cde2fb'),
    highlight='#e66767',
    status_good='#0ca30c',
    status_warning='#fab219',
    status_serious='#ec835a',
